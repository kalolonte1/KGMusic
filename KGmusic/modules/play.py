...
from KGmusic.services.callsmusic.callsmusic import queues
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("⏺️ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/rakasupport")
                ],
            ]
        )
        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/file/2ee70f32d0372472b5f66.png"
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("⏺️ ᴄʜᴀɴɴ", url=f"https://t.me/rakasupport")
                ],
            ]
        )
        requested_by = message.from_user.first_name
        ...
        try:
            ...
            while j < 5:
                ...
                toxxt += f" └ ⚡ **__Empowered by KGMusic**\n\n"
            ...
            await message.reply_photo(
                photo="https://telegra.ph/file/8f492e14bbe4175ea6e07.jpg",
