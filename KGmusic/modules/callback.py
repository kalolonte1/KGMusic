...
from KGmusic.config import BOT_NAME, BOT_USERNAME, OWNER, SUPPORT_GROUP, UPDATES_CHANNEL, ASSISTANT_NAME
...
<b>""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                   InlineKeyboardButton(
                       "🛠️ Source code", url=f"https://github/kalolonte1/KGMusic"
                   ),
                   InlineKeyboardButton(
